...
$cekEvent 		= $this->query->getNumRowsbyQ("select * from menu_site where style='event'")->num_rows();
$cekBrand 		= $this->query->getNumRowsbyQ("select * from menu_site where style='brand'")->num_rows();
$cekLive 		= $this->query->getNumRowsbyQ("select * from menu_site where style='stream'")->num_rows();
?>
<!-- begin:: Content -->
						...
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							...
							<div class="kt-portlet__body">
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Menu Name *</label>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<input type="text" name="desc" class="form-control" id="desc" placeholder="Menu Description">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Parent Menu *</label>
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Add Data After *</label>
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Menu Type *</label>
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<select name="menutype" class="form-control" id="menutype" placeholder="Menu Type">
												...
												<option value="gallery">Lookbook</option>
												<option value="product">Product</option>
												<?PHP if ($cekBrand<1) { ?><option value="brand">Brand</option><?PHP } ?>
												<?PHP if ($cekStream<1) { ?><option value="stream">Live</option><?PHP } ?>
