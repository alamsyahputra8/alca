			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						&nbsp;
						<?PHP echo getRoleInsert($akses,'addnewfac','Add New Brand');?>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="kt-form kt-form--label-right" id="forminsert" enctype="multipart/form-data">
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Add New Brand</h3>
								</div>
							</div>
							<div class="kt-portlet__body">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Size Chart *</label>
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<input type="file" name="schart" class="form-control" id="schart" placeholder="Size Chart">
										</div>
										<span class="form-text text-muted">Untuk tampilan lebih maksimal, gambar disarankan dengan ukuran di bawah 1MB</span>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<select name="rating" class="form-control" id="rating" placeholder="Rating">
							...
							<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
								...
								<div class="kt-portlet__body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<input type="file" name="ed_schart" class="form-control" id="ed_schart" placeholder="Size Chart">
											</div>
											<span class="form-text text-muted">Kosongkan apabila tidak akan merubah Size Chart.</span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<select name="ed_rating" class="form-control" id="ed_rating" placeholder="Rating">
													<option value="1">1 <i class="fa fa-star"></i></option>
													<option value="2">2 <i class="fa fa-star"></i></option>
													<option value="3">3 <i class="fa fa-star"></i></option>
													<option value="4">4 <i class="fa fa-star"></i></option>
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<input type="number" name="ed_sort" class="form-control" id="ed_sort" placeholder="Sort">
											</div>
										</div>
									</div>
								</div>
