...
$q 				= "
				...
				from menu_site a 
				where style in ('product') order by sort asc
				";
...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
	...
	<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						&nbsp;
						<?PHP echo getRoleBtnAction($akses,'update','Update Live Streaming','update','btn-primary btnupdateM','la la-video-camera');?>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="kt-portlet__body">
			...
			<div id="bgstreaming">
				<div class="loadermini kt-spinner kt-spinner--lg kt-spinner--primary kt-spinner--right"></div>
			</div>
							...
							<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
								...
								<div class="kt-portlet__body">
									...
									<div class="form-group row">
										<label class="col-form-label col-lg-3 col-sm-12">Embed *</label>
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<input type="text" name="embed" class="form-control" id="embed" placeholder="Embed">
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<div class='input-group'>
												<textarea name="desc" class="form-control summernote" id="desc"></textarea>
											</div>
											<!-- <span class="form-text text-muted">Tambahkan <b><code>&ltbr&gt</code></b> jika ingin menambahkan "Enter" atau baris baru.</span> -->
										</div>
									</div>
