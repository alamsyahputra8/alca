			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						&nbsp;
						<?PHP echo getRoleInsert($akses,'addnewfac','Add New Ads');?>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="kt-form kt-form--label-right" id="forminsert" enctype="multipart/form-data">
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Add New Ads</h3>
								</div>
							</div>
							...
							<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
								...
								<div class="kt-portlet__body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<select name="ed_type" class="form-control" id="ed_type" placeholder="Type">
													<option value="left">Left</option>
													<option value="right">Right</option>
													<option value="center">Center</option>
												</select>
