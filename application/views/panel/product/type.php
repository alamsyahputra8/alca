			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						&nbsp;
						<?PHP echo getRoleInsert($akses,'addnewfac','Add New Product Type');?>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="kt-form kt-form--label-right" id="forminsert" enctype="multipart/form-data">
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Add New Product Type</h3>
								</div>
							</div>
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<select name="menu" class="form-control select2norm" id="menu" placeholder="Menu" style="width: 100%;">
												<option value=""></option>
												<?PHP foreach ($getDataMenu as $dataM) { $idmenu = $dataM['id_menu']; ?>
													<option value="<?PHP echo $idmenu; ?>"><?PHP echo $dataM['menu']; ?></option>
												<?PHP } ?>
											</select>
										</div>
										<!-- <span class="form-text text-muted">Tambahkan <b><code>&ltbr&gt</code></b> jika ingin menambahkan "Enter" atau baris baru.</span> -->
