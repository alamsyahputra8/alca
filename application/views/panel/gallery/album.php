			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						&nbsp;
						<?PHP echo getRoleInsert($akses,'addnewfac','Add New Album');?>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="kt-form kt-form--label-right" id="forminsert" enctype="multipart/form-data">
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Add New Album</h3>
								</div>
							</div>
							<div class="kt-portlet__body">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-3 col-sm-12">Works Menu *</label>
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<select name="works" class="form-control select2norm" id="works" placeholder="Works Menu" style="width: 100%;">
												<option value="">-- Choose Works Menu --</option>
								...
								<div class="form-group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class='input-group'>
											<input type="file" name="pict" class="form-control" id="pict" placeholder="Icon">
										</div>
							...
							<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
								...
								<div class="kt-portlet__body">
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<select name="ed_service" class="form-control select2norm" id="ed_service" placeholder="Service" style="width: 100%;">
													<option value="">-- Choose Service --</option>
													<?PHP foreach ($getDataService as $data) { ?>
													<option value="<?PHP echo $data['id_menu']; ?>"><?PHP echo $data['menu']; ?></option>
													<?PHP } ?>
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<select name="ed_works" class="form-control select2norm" id="ed_works" placeholder="Works Menu" style="width: 100%;">
													<option value="">-- Choose Works Menu --</option>
													<?PHP foreach ($getDataMenu as $data) { ?>
													<option value="<?PHP echo $data['id_menu']; ?>"><?PHP echo $data['menu']; ?></option>
													<?PHP } ?>
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group'>
												<input type="file" name="upl" class="form-control" id="upl" placeholder="Icon">
											</div>
											<span class="form-text text-muted">Untuk tampilan lebih maksimal, gambar disarankan dengan bentuk kotak (150px x 150px)</span>
										</div>
									</div>
