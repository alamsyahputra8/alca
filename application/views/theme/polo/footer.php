            ...
            <div class="footer-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="widget">
                                ...
                                <div class="widget-title">
                                    <!-- <img src="<?PHP echo base_url(); ?>images/<?PHP echo $site['logo']; ?>" alt="SarangVisuell" style="margin-left: -2rem; max-width: 100%"> -->
                                    Contact Us
                                </div>
                                <div><?PHP echo $site['maps']; ?></div>
                                <div><?PHP echo $site['alamat']; ?></div>
                                <div>
                        ...
                        <div class="col-lg-4">
                            <div class="widget">
                                <div class="widget-title">Other Menu</div>
                                <ul class="list">
                                    <?PHP
                                    $getOC  = $this->query->getDatabyQ("select * from menu_site where style in ('about','other','contact') order by sort");
                        ...
                        <div class="col-lg-4">
                            <div class="widget">
                                <div class="widget-title">Payment Option</div>
                                <div>
                                    <img src="<?PHP echo base_url(); ?>images/payment.png" style="max-width: 90%;">
                                </div>
                            </div>  
                        </div>
                        <!-- <div>
