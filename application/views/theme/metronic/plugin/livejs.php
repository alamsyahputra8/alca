...
$(window).bind("load", function() {
    $("#bgstreaming").load( "<?PHP echo base_url(); ?>core/getdataStream", function() {
        $(".loadermini").fadeOut('slow');
    });
});
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalstream',
        type: 'POST',
        data: 'id=1',
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#desc').summernote('code', data.description);
...
$(document).on('click', '.btndeleteMenu', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalproducttype',
        type: 'POST',
        data: 'id='+id,
        dataType: 'json'
    })
...
var KTDatatablesSearchOptionsColumnSearch = function() {
	...
	var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdataproducttype',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'name', 'menu', 'updateby', 'lastupdate', 'actions',],
                },
            },
			columns: [
                {data: 'name'},
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertproducttype",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updatestream",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deleteproducttype",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
