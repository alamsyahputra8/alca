...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalvideos',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class='input-group'>
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger text-white deleterow" title="Remove Video" data-id="#newrow`+x+`">
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertvideos",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deletevideos",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
