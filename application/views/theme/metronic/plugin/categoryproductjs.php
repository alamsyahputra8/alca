...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalproductCat',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#ed_id').val(data.id_category);
        $('#ed_name').val(data.name);
        
        $('#ed_type').val(data.id_type);
        $('#ed_type').trigger('change.select2');
...
var KTDatatablesSearchOptionsColumnSearch = function() {
	...
	var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdataproductCat',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'name', 'type', 'updateby', 'lastupdate', 'actions',],
                },
            },
			columns: [
                {data: 'name'},
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertproductCat",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updateproductCat",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deleteproductCat",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
