...
//     $.ajax({
//         url: '<?PHP echo base_url(); ?>core/modalproductimg',
//         type: 'POST',
//         data: 'id='+uid,
//         dataType: 'json'
//     })
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertimageproduct",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deleteimg_product",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
