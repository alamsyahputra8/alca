...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalevent',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#namedata').html(data.nama);
        $('#ed_id').val(data.id_event);
        $('#ed_title').val(data.nama);
        $('#ed_location').val(data.lokasi);
        $('#ed_date').val(data.tanggal);
        $('#ed_expired').val(data.expired);
...
var KTDatatablesSearchOptionsColumnSearch = function() {
	...
	var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdataevent',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'event', 'location', 'date', 'expired', 'updateby', 'lastupdate', 'actions',],
                },
            },
			columns: [
                {data: 'event'},
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertevent",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updateevent",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deleteevent",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
