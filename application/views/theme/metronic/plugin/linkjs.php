...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modallink',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#ed_id').val(data.id_link);
        $('#ed_title').val(data.title);
        $('#ed_link').val(data.link);
        $('#ed_rating').val(data.rating);
...
var KTDatatablesSearchOptionsColumnSearch = function() {
	...
	var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdatalink',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'picture', 'sizechart', 'title', 'link', 'rating', 'sort', 'updateby', 'lastupdate', 'actions',],
                },
            },
			columns: [
                {data: 'picture'},
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertlink",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updatelink",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deletelink",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
