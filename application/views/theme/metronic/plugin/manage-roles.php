...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalrole',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#exmod').load("<?PHP echo base_url(); ?>core/getdataEksMod/"+data.id_role+"", function(){});
...
var KTDatatablesDataSourceAjaxServer = function() {
	...
	var initTable1 = function() {
		...
		var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdataroles',
                type: 'POST',
                data: {
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertroles",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updaterole",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteRoles').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deleterole",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
