...
$qWork      = "
            ...
            (
                select * from (
                    select id_video as id_file,id_menu, id_album, video as file, '2' as type, '1' as sort from videos 
                    union 
                    select id_photo as id_file,id_menu, id_album, picture as file, '1' as type, '2' as sort from photos
                ) as base
            ) as a
            where id_album='$id'
            order by sort,id_file desc
            ";
            //echo "<pre>".$qWork."</pre>";
?>
...
<div id="portfolio" class="grid-layout portfolio-3-columns" data-margin="20">
    ...
    foreach($gWork as $data) {
        ...
        if ($type=='1') {
                ...
                <div class="portfolio-item '.$size.' img-zoom ct-foto">
                    <div class="portfolio-item-wrap">
                        ...
                        <div class="portfolio-description">
                            <a title="" data-lightbox="image" href="'.base_url().'images/gallery/'.$file.'">
            ...
            $fileembed  = str_replace('https://www.youtube.com/embed/','https://www.youtube.com/watch?v=',$file);

            echo '
                <div class="portfolio-item '.$size.' img-zoom ct-video">
                   <div class="portfolio-item-wrap">
                        <div class="portfolio-image">
                            <iframe width="100%" height="150px" src="'.$embed.'?rel=0&amp;showinfo=0" allowfullscreen></iframe>
                        </div>
                        <div class="portfolio-description">
