...
<link href='https://parwatha.com/polo/js/plugins/components/fullcalendar/fullcalendar.min.css' rel='stylesheet' />
        ...
        <script src='https://parwatha.com/polo/js/plugins/components/moment.min.js'></script>
        <script src='https://parwatha.com/polo/js/plugins/components/fullcalendar/fullcalendar.min.js'></script>
        <script>
