<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	function getRoleInsert($akses,$modal_name,$name_button){
		...
		$clearbuton = '
					<button class="btnclearfilter btn btn-default btn-btn-sm"><i class="fa fa-eraser p-r-5"></i> Clear Filter</button>
					<script>
		...
		{
			$button = '
					<button class="btnaddnewdata btn btn-brand btn-elevate btn-icon-sm" data-toggle="modal" data-target="#'.$modal_name.'">
	...
	function getRoleBtnAction($akses,$modal_name,$name_button,$actbtn,$classbtn,$iconbtn){
		...
		{
			$button = '
					<button class="btn btn-brand '.$classbtn.' btn-icon-sm" data-toggle="modal" data-target="#'.$modal_name.'">
						<i class="'.$iconbtn.'"></i>
						'.$name_button.'
					</button>
					';
