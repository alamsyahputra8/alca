...
class Viewpanel extends CI_Controller {
	...
	public function product(){
		if(checkingsessionpwt()){
			...
			if ($cekAkses=='') {
				...
				// CONTENT
				$this->load->view('panel/product/product', $data);
	...
	public function product_category(){
		if(checkingsessionpwt()){
			...
			if ($cekAkses=='') {
				...
				// CONTENT
				$this->load->view('panel/product/category', $data);
	...
	public function product_type(){
		if(checkingsessionpwt()){
			...
			if ($cekAkses=='') {
				...
				// CONTENT
				$this->load->view('panel/product/type', $data);
	...
	public function product_image($id){
		if(checkingsessionpwt()){
			...
			$userid 	 	= $session['userid'];
			$profile 	 	= $session['id_role'];
			$data_akses  	= $this->query->getAkses($profile,'panel/product');
			$shift 		 	= array_shift($data_akses);
			$data['akses']	= $shift['akses'];
			$data['userid'] = $userid;
			$data['id']		= $id;
			...
			// CONTENT
			$this->load->view('panel/product/product-image', $data);
	...
	public function stream(){
		if(checkingsessionpwt()){
			...
			if ($cekAkses=='') {
				...
				// CONTENT
				$this->load->view('panel/stream/stream', $data);
